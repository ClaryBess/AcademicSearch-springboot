...
public class CollectionService {
    ...
    //添加收藏
    public int insertCollection(Integer Did,String Pid,Integer user){
        return collectionMapper.insertCollection(Did,Pid,user);
    }

    //在文献页面取消收藏
    public int DeleteCollectionInPaper(Integer user, String paper){
    ...
    //展示某文献的收藏状态
    public int ShowCollectionStatus(String paper,Integer user){
